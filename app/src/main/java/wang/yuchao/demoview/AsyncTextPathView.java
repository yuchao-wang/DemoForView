 ...
 * Description :
 */
public class AsyncTextPathView extends View {
    ...
    public AsyncTextPathView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context);
    }

    public AsyncTextPathView(Context context, AttributeSet attrs, int defStyleAttr) {
